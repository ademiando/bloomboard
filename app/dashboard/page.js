 ...
 * - Single green "Add Assets" button
 * - Deposit system with IDR/USD inputs
 * - Invested value from accumulated deposits
 * - Trading balance management
 * - Perfect circle donut allocation
 * - Asset chart on click (TradingView/CoinGecko fallback)
 * - Dropdown filter instead of "All Portfolio" button
 * - Proper growth calculations
 */
...
// ========== DONUT ALLOCATION (PERFECT CIRCLE) ==========
function CakeAllocation({ data = [], size = 200, inner = 48, gap = 0.02, displayTotal = "", displayCcy = "USD", usdIdr = 16000 }) {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-6 mt-8">
      ...
      {/* Legend with small text and round color boxes */}
